    ...
    return (
        <View className={`{space-y-2 ${otherStyles}`}>
            ...
            <View className="w-full flex-row h-16 bg-black-100 border-2 border-black-200 rounded-2xl focus:border-secondary items-center">
                <TextInput secureTextEntry={title === "Password" && !showPassword} value={value} onChangeText={handleChageText} placeholderTextColor="#7b7b8b" placeholder={placeholder} className="flex-1 p-2 text-white font-psemibold text-base"/>
